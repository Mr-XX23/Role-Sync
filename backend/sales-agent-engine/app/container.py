...
async def build_container(
    ...
    *,
    ...
    try:
        ...
        credit_meter = UsageMeter(billing)
        ...
        model_router = ModelRouter(
            ...
            tracer,
            meter=usage_meter(admin_store),  # Super Admin Console usage stats
            credit_meter=credit_meter,  # credits charged to the workspace
        )
        workspaces = WorkspaceDirectory(
